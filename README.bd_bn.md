...
অ্যাসেম্বলার     | yaYUL
যোগাযোগ      | রন বার্কে <info@sandroid.org>
ওয়েবসাইট      | www.ibiblio.org/apollo
ডিজিটালাইজেশন | এই উৎস কোডটি এমআইটি জাদুঘরের একটি হার্ডকপির ডিজিটাইজড চিত্র থেকে অনুলিপি করা হয়েছে বা অন্যথায় রূপান্তরিত হয়েছে। ডিজিটালাইজেশনটি পাউল জেল্ড সঞ্চালনা করেছিলেন এবং যাদুঘরের ডেবোরা ডগলাস দ্বারা ব্যবস্থা করেছিলেন। উভয়কে অনেক ধন্যবাদ।
