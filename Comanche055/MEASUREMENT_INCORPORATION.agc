...
#	   Z1 = VECTOR USED FOR THE INCORPORATION 6 OR 9 DIMENSIONAL
#     GAMMA = SCALAR
...
# Page 1253
		...
		MXV*	VAD*
			W +162D,1
			Z1 +18D,2	# B(0)*W+B(1)*(W+54)+B(2)*(W+108)FIRST PASS
		STORE	Z1 +18D,2	# Z1 THEN Z2 THEN Z3
		TIX,1
			INCOR1
INCOR1		TIX,2	BON
...
INCOR1A		SETPD	VLOAD
		...
		TAD	AXT,2
			VARIANCE
			0
		STORE	TRIPA		# Z1*2 + Z2*2 + Z3*2 + VARIANCE
		TLOAD	BOV
...
#    Z1      = 	VECTOR USED IN INCORPORATION
